...
class Userinfo(db.Model):
  ...
  twitter_request_token = db.StringProperty(required=False)
  twitter_request_secret = db.StringProperty(required=False)
  twitter_oauth_token = db.StringProperty(required=False)
