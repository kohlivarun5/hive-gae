...
"""
  ...
  page.body.attributes["style"] = "padding-left:15px;padding-right:15px;background-color:#dedede"
  ...
  def _make_navbar():
    main = div(cl="navbar navbar-inverse navbar-fixed-top",style="margin-right:-15px")
